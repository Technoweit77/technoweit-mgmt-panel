...
const Offerletter = ({ data }) => {
  let { studentData, dateOfIssue, joiningDate } = data;
  return (
    <Document>
      <Page size="A4">
        ...
        <View style={styles.container}>
          ...
          <View style={styles.page}>
            <View>
              <Text style={styles.cdate}> Date :  {dateOfIssue}</Text>
              {/* 18-01-2024   */}

            </View>
            <View>
              <Text style={styles.letter}> JOINING LETTER</Text>
            ...
            <View style={styles.content}>
              <Text style={styles.firstLineIndent}>
                With reference to the interview you had with us, we would like
                to make you an offer for the position of “Jr. Web Developer
                Trainee”. You will be training for Six months. At the end of Six
                months, on successful completion of the training period,
                depending on your performance, you will be confirmed as “Jr. Web
                Developer”.
              </Text>
              <Text style={styles.firstLineIndent}>
                We have an extremely challenging and exciting career path
                designed for you, with an equally matching compensation. We will
                be able to process your offer further as soon as we get
                acceptance about the same. Looking forward to a long and
                fulfilling professional relationship.
              </Text>
              <Text style={styles.firstLineIndent}>
                Date of Joining: you have joined us on {joiningDate}
              </Text>
