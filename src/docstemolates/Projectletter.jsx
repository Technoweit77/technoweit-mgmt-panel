...
const Projectletter = ({ data }) => {
    let { studentData, collegeName, projectTitle, dateOfIssue, joiningDate } = data;
    return (
        <Document>
            <Page size="A4">
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.page}>
                        <View>
                            <Text style={styles.cdate}> Date :  02/06/2025</Text>
                            {/* 18-01-2024   */}

                        </View>
                        <View>
                            <Text style={styles.letter}> CERTIFICATE </Text>
